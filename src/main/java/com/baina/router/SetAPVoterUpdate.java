...
public class SetAPVoterUpdate {
	...
	public void process(Exchange exchange) {
		/*
		 * VoterDetails enrollment = (VoterDetails)
		 * exchange.getProperty("voterResponse");
		 */
		VoterDetails enrollment=VoterUtilityConstants.voterDetails;
		System.out.println(enrollment+"***********");
		ApVoter tv = new ApVoter();
		...
		VoterDetails response = service.storeApVoter(tv);
